  ...
  <div class="payment_address">
    ...
    >
      <div
        ...
        v-show="popupPaymentOptionsData"
      >
          ...
          <div class="col">
            <div class="input-group">
              <b-form-group label="เบอร์โทรศัพท์">
                <b-form-input
                  :state="!errors.has('tel')"
                  v-validate="{ required: true, min:9, max: 10, numeric: true  }"
                  name="tel"
                  v-model="form.tel"
                  type="text"
          ...
          <div class="col-12 col-sm-12 col-md-6">
            <div class="input-group">
              <b-form-group label="บ้านเลขที่">
                <b-form-input
                  :state="!errors.has('house_no')"
                  v-validate="{ required: true, min: 1 }"
                  name="house_no"
                  v-model="form.house_no"
                  type="text"
                  placeholder="เช่น 38/5, 24/589"
                ></b-form-input>
          ...
          <div class="col">
            <div class="input-group">
              <b-form-group label="หมู่บ้าน">
                <b-form-input
                  :state="!errors.has('village_no')"
                  v-validate="{ required: true, }"
                  name="village_no"
                  v-model="form.village_no"
                  type="text"
          ...
          <div class="col">
            <div class="input-group">
              <b-form-group label="รหัสไปรษณีย์">
                <b-form-input
                  :state="!errors.has('zip')"
                  v-validate="{ required: true, regex: /^(\d{5})?$/ }"
                  name="zip"
                  v-model="form.zip"
                  type="text"
                  placeholder="เช่น 10510"
                ></b-form-input>
