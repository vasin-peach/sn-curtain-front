...
!(function(e) {
  ...
  function(e, t, n) {
    ...
    function o(e) {
      ...
      return (
        e.vaultUrl && (0, a.isUri)(e.vaultUrl)
          ? e.cardHost && (0, a.isUri)(e.cardHost)
            ? (e.interfaceUrl && (0, a.isUri)(e.interfaceUrl)) ||
              (t.message = 'Missing interfaceUrl')
            : (t.message = 'Missing cardHost')
          : (t.message = 'Missing valutUrl'),
        (t.error = '' !== t.message),
        t
      )
    }
        ...
        i(e, [
          ...
          },
          {
            ...
            value: function(e, t, n) {
              var r = {}
              ;(r[e] = t),
                this._createRpc(function() {
                  n(0, {
                    code: 'rpc_error',
                    message:
                      'unable to connect to provider after timeout',
                  })
                }).createToken(
                  this.publicKey,
                  r,
  ...
  function(e, t, n) {
    ...
    var s = n(8),
      ...
      l = (t.defaultIframeAppConfig = {
        ...
        currency: 'THB',
        image:
          'https://cdn.omise.co/assets/frontend-images/store-logo.svg',
        frameLabel: 'Omise',
          ...
          a(e, [
            ...
            },
            {
              ...
              value: function() {
                for (
                  ...
                  var o = t[r]
                  if (
                    o.hasAttribute('data-key') &&
                    o.hasAttribute('data-amount')
                  ) {
                ...
                e ||
                  this.isInsideIframeApp() ||
                  !this.app.omiseScriptTag ||
                  (this.createIframe(),
            ...
            },
            {
              ...
              value: function(e) {
                ...
                this.app.formElement &&
                  (this.isOmiseSource(e)
                    ? (this.app.formElement.omiseSource.value = e)
                    : (this.app.formElement.omiseToken.value = e)),
                  'yes' === n &&
                    this.app.formElement &&
            ...
            },
            {
              ...
              value: function() {
                ...
                return (
                  (t.id = this.app.iframeAppId),
                  (t.src = this.app.settings.cardHost + '/pay.html'),
                  t.setAttribute('style', f.join('; ')),
                  document.body.appendChild(t),
                  (t.onload = function() {
                    'block' === e.app.iframe.style.display &&
                      (0, s.messageShowIframeAppForm)(
                        t.contentWindow,
                        {
            ...
            },
            {
              ...
              value: function(e) {
                ...
                null == n &&
                  ...
                  n.setAttribute('name', 'omiseToken'),
                  t.appendChild(n))
                ...
                return (
                  null == r &&
                    ...
                    r.setAttribute('name', 'omiseSource'),
                    t.appendChild(r)),
                  n
                )
              },
            },
            {
              ...
              value: function() {
                var e = this,
                  t = this.prepareConfig(
                    (0, u.extractDataFromElement)(
                      this.app.omiseScriptTag,
                    ),
                  ),
                  n = document.createElement('button')
                ;(n.className = 'omise-checkout-button'),
                  (n.innerHTML = t.buttonLabel)
                var r = this.app.omiseScriptTag
                if (r) {
                  var o = this.getFormByTarget(r)
                  ;(this.app.formElement = o),
                    this.createHiddenInputForOmiseToken(o)
                    ...
                    function(t) {
                      if ((t.preventDefault(), r)) {
                        var n = (0, u.extractDataFromElement)(r),
                          o = e.prepareConfig(n)
                        ;(e.app.configForIframeOnLoad = i({}, o)),
                          e.open(o)
                      } else console.warn('Missing Omise script tag')
                    },
                    !1,
            ...
            },
            {
              ...
              value: function() {
                return (
                  null !=
                  document.getElementById(this.app.iframeAppId)
                )
              },
            },
            {
              ...
              value: function() {
                ...
                return (
                  t &&
                    'string' == typeof t &&
                    (e.otherPaymentMethods = this.stringToArray(t)),
                  (0, u.merge)(this.app.defaultConfig, o(e))
                )
              },
            },
            {
            ...
            },
            {
              ...
              value: function(e) {
                return (
                  (this.app.defaultConfig = this.prepareConfig(e)),
                  this.isInsideIframeApp() ||
                    this.app.iframe ||
                    (this.createIframe(), (0, c.default)(this)),
                  this.app.defaultConfig
                )
              },
            },
            {
              ...
              value: function() {
                ...
                return (
                  (this.app.currentOpenConfig = i({}, r)),
                  setTimeout(function() {
                    ;(e.app.iframe.style.backgroundColor =
                      'rgba(0, 0, 0, .4)'),
                      (0, s.messageShowIframeAppForm)(
                        e.app.iframe.contentWindow,
                        {
                          config: r,
                        },
                      ),
            ...
            },
            {
              ...
              value: function() {
                ...
                return (
                  !!this.app.iframe &&
                  ((this.app.iframe.style.backgroundColor =
                    'rgba(0, 0, 0, 0)'),
                  setTimeout(function() {
                    ;(e.app.iframe.style.display = 'none'),
                      t(e.app.iframe),
                      (e.app.currentOpenConfig.onFormClosed || p)(
                        e.app.iframe,
                      )
                  }, 250),
                  !0)
                  ...
                  this.app.allConfigureButtons.forEach(function(n) {
                    ...
                    var s = e.app.defaultConfig.submitFormTarget,
                      c = s
                        ...
                        : e.getFormByTarget(o)
                    e.createHiddenInputForOmiseToken(c),
                      o.addEventListener(
                        'click',
                        function(t) {
                          t.preventDefault()
                          t.target
                          ;(e.app.configForIframeOnLoad = r),
                            (e.app.formElement = c),
                            e.open(r)
                        },
                        !1,
  ...
  function(e, t, n) {
    ...
    !(function(e, t, n, o, i, a) {
      ...
      function l() {
        ...
        if (
          !w(navigator.plugins) &&
          'object' == r(navigator.plugins[e])
        ) {
          var n = navigator.plugins[e].description
          n &&
            !w(navigator.mimeTypes) &&
      ...
      function d() {
        var e = parent
        if ('' !== L)
          for (var t = 0, n = L.split('.'); t < n.length; t++)
            e = e[n[t]]
        return e.easyXDM
      }
      ...
      function v(e) {
        if (
          ((e = e.replace(N, '$1/')), !e.match(/^(http||https):\/\//))
        ) {
          ...
          if (
            ...
            for (var s in e.usePost)
              e.usePost.hasOwnProperty(s) &&
                (S
                  ? (i = t.createElement('<input name="' + s + '"/>'))
                  : ((i = t.createElement('INPUT')), (i.name = s)),
                (i.value = e.usePost[s]),
                a.appendChild(i))
      ...
      function T(r) {
        var o,
          i = r.protocol
        if (
          ((r.isHost = r.isHost || w($.xdm_p)),
          (q = r.hash || !1),
          r.props || (r.props = {}),
          r.isHost)
        )
          (r.remote = v(r.remote)),
            (r.channel = r.channel || 'default' + I++),
            ...
            w(i) &&
              (i =
                g(n.href) == g(r.remote)
                  ? '4'
                  : s(e, 'postMessage') || s(t, 'postMessage')
                  ? '1'
                  : r.swf && s(e, 'ActiveXObject') && l()
                  ? '6'
          ...
          ((r.channel = $.xdm_c.replace(/["'<>\\]/g, '')),
          (r.secret = $.xdm_s),
          (r.remote = $.xdm_e.replace(/["'<>\\]/g, '')),
          (i = $.xdm_p),
          r.acl && !x(r.acl, r.remote))
        )
        ...
        switch (((r.protocol = i), i)) {
          case '0':
            if (
              ...
              if (!r.local) {
                for (
                  ...
                  if (
                    ((a = u[f]), a.src.substring(0, c.length) === c)
                  ) {
                    r.local = a.src
                    break
                  }
            ...
            o = [
              new H.stack.HashTransport(r),
              new H.stack.ReliableBehavior({}),
              new H.stack.QueueBehavior({
                encode: !0,
      ...
      _(H, {
        ...
        (H.Rpc = function(e, t) {
          ...
          var o = E(
            T(e).concat([
              new H.stack.RpcBehavior(this, t),
              {
                callback: function(t) {
                  e.onReady && e.onReady(t)
                },
          ...
          function i(n) {
            ...
            H.Fn.set(
              ...
              function() {
                ...
                for (
                  var e = H.stack.FlashTransport[n].queue, t = 0;
                  t < e.length;
                  t++
                )
                  e[t]()
          ...
          return (s = {
            ...
            onDOMReady: function() {
              ;(u = e.remote),
                ...
                H.Fn.set('flash_' + e.channel + '_onMessage', r),
                (e.swf = v(e.swf))
              var t = m(e.swf),
                a = function() {
                  ;(H.stack.FlashTransport[t].init = !0),
                    (l = H.stack.FlashTransport[t].swf),
                    l.createChannel(
                      e.channel,
                      e.secret,
                      g(e.remote),
              ...
              H.stack.FlashTransport[t] &&
              H.stack.FlashTransport[t].init
                ? a()
                : H.stack.FlashTransport[t]
                ? H.stack.FlashTransport[t].queue.push(a)
                : ((H.stack.FlashTransport[t] = {
                    queue: [a],
                  }),
                  i(t))
          ...
          function i(e) {
            ...
            n == u &&
              e.data.substring(0, t.channel.length + 1) ==
                t.channel + ' ' &&
              a.up.incoming(e.data.substring(t.channel.length + 1), n)
          }
          var a, s, c, u
          return (a = {
          ...
          return (a = {
            ...
            onDOMReady: function() {
              ;(s = e.isHost),
                ...
                (e.local = v(e.local)),
                s
                  ? (H.Fn.set(e.channel, function(t) {
                      s &&
                        'ready' === t &&
                        (H.Fn.set(e.channel, r), n())
                    }),
                    (h = b(e.remote, {
                      xdm_e: e.local,
                      xdm_c: e.channel,
                  ...
                  : ((e.remoteHelper = e.remote),
                    H.Fn.set(e.channel, r))
              var t = function t() {
                var r = c || this
                M(r, 'load', t),
                  H.Fn.set(e.channel + '_load', i),
                  (function e() {
        ...
        (H.stack.HashTransport = function(t) {
          ...
          function r(e) {
            ;(f = e),
              s.up.incoming(f.substring(f.indexOf('_') + 1), v)
          }
          ...
          return (s = {
            ...
            destroy: function() {
              e.clearInterval(u),
                (!c && y) || m.parentNode.removeChild(m),
                (m = null)
            },
            onDOMReady: function() {
              if (
                ...
                if (
                  ...
                  !(function e() {
                    ...
                    try {
                      h =
                        m.contentWindow.frames[
                          J + t.channel + '_consumer'
                        ]
                    } catch (e) {}
          ...
          return (t = {
            incoming: function(e, a) {
              ...
              ;(e = e.substring(s + 1)),
                c[0] == r && ((i = ''), n && n(!0)),
                e.length > 0 &&
                  (t.down.outgoing(c[1] + ',' + r + '_' + i, a),
                  o != c[1] && ((o = c[1]), t.up.incoming(e, a)))
            },
            ...
            incoming: function(i, a) {
              ...
              ;-1 === s
                ? i === r
                  ? n.up.callback(!0)
                  : o ||
                    ((o = i), e.initiate || t(), n.down.outgoing(i))
                : i.substring(0, s) === o &&
                  n.up.incoming(i.substring(s + 1), a)
            },
        ...
        (H.stack.RpcBehavior = function(e, t) {
          ...
          function r(e, t) {
            ...
            return function() {
              ...
              i > 0 && 'function' == typeof arguments[i - 1]
                ? (i > 1 && 'function' == typeof arguments[i - 2]
                    ? ((o = {
                        success: arguments[i - 2],
                        error: arguments[i - 1],
                      }),
                      (a.params = r.call(arguments, 0, i - 2)))
                    : ((o = {
                        success: arguments[i - 1],
                      }),
                      (a.params = r.call(arguments, 0, i - 1))),
                  (c['' + ++s] = o),
                  (a.id = s))
          ...
          return (i = {
            incoming: function(e, r) {
              ...
              if (i.method)
                t.handle
                  ? t.handle(i, n)
                  : o(i.method, i.id, t.local[i.method], i.params)
              else {
                var s = c[i.id]
                i.error
                  ? s.error && s.error(i.error)
                  : s.success && s.success(i.result),
                  delete c[i.id]
              }
            },
            init: function() {
  ...
  function(e, t, n) {
    ...
    ;(function(t) {
      ...
      var o = n(0),
        ...
        u = r(c)
      ;(e.exports = s.default),
        (t.Omise = new s.default(i.default)),
        (t.OmiseCard = new u.default(i.default))
    }.call(t, n(1)))
  },
  function(e, t, n) {
    'use strict'
    ;(function(e) {
      ...
      Object.defineProperty(t, '__esModule', {
        ...
        (t.default = r),
        (t.messageShowIframeAppForm = o),
        (t.messageCloseIframe = i),
        (t.messageCloseAndSendToken = a)
      var u = n(0),
        l = (function(e) {
          return e && e.__esModule
            ? e
          ...
          var v = [
            ...
            w =
              ...
              function(e) {
                return (
                  e &&
                  v.indexOf(Object.prototype.toString.call(e)) > -1
                )
              }
